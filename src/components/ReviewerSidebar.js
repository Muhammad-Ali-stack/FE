  ...
  return (
    ...
    >
      ...
      <nav className="flex flex-col flex-1 p-4 space-y-2 overflow-y-auto">
        {[
          { to: "/userdashboard/conferences-reviewer", label: "Conferences", icon: "m4.5 12.75 6 6 9-13.5" },
          { to: "/userdashboard/all-assigned-papers", label: "Papers", icon: "M12 6.042A8.967 8.967 0 0 0 6 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 0 1 6 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 0 1 6-2.25c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0 0 18 18c-2.305 0-4.408.867-6 2.292m0-14.25v14.25" }
        ].map((item, idx) => (
          <NavLink
            key={idx}
            to={item.to}
